...
& java -jar swagger-codegen-cli.jar generate -i https://api.cloudmersive.com/spam/v1/swagger.json -l php -c packageconfig.json
#(Get-Content ./client/package.json).replace('v1', '1.0.1') | Set-Content ./client/package.json
Copy-Item ./cloudmersive_spam_api_client/* -Destination . -Recurse -Force
...
(Get-Content ./README.md).replace('This PHP package is automatically generated by the [Swagger Codegen](https://github.com/swagger-api/swagger-codegen) project:', '[Cloudmersive Barcode API](https://cloudmersive.com/spam-detection-api) provides advanced spam detection capabilities.') | Set-Content ./README.md
